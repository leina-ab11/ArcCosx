...
* gui.py: This is responsible for a gui for the user to enter values within [-1,1], it shows the results for the user and the errors accordingly. It also contains the version number. 
...
* main.py: This is the old textual interface from D1. It is left in the repository for reference. gui.py is an incremental enhancement of main.py. This is now moved to D1 folder to archive it since the GUI in gui.py is the latest implementation of the project.
...
* unit_tests.py: This is responsible for unit tests to ensure all cases are covered.
...
python main.py
```
* To run the code based on D2 & D3 requirements you run:
```bash
python gui.py
```
