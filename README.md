...
* main.py: This is the old textual interface from D1. It is left in the repository for reference. This is not needed for D2. gui.py is an incremental enhancement of main.py.
